...
As of July 28, 2026, the curated sections below contain 71 entries aligned to the repository taxonomy.
...
- **[AgentRadio](https://arxiv.org/abs/2607.28430)** - Introduces an asynchronous message-passing layer that enables passive awareness between coding agents during long-horizon multi-agent collaboration. *Framework / communication observability*
...
- **[SafeFlow](https://github.com/Haowen-academic/SafeFlow)** - Research framework for building and evaluating safe multi-agent systems using taint propagation, context reconstruction, local tool checks and global validation. *Framework / workflow safety*
